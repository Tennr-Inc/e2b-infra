...
locals {
  ...
  orchestrator_env_vars = merge({
    ...
    ENVD_UPGRADE_TARGET          = var.envd_upgrade_target
...
module "cluster" {
  ...
  client_max_cluster_size             = var.client_max_cluster_size
  client_reserved_host_memory_mib     = var.client_reserved_host_memory_mib
  client_base_hugepages_percentage    = var.client_base_hugepages_percentage
  client_sandbox_memory_limit_mib     = var.client_sandbox_memory_limit_mib
  client_max_sandboxes_per_node       = var.client_max_sandboxes_per_node
  ...
  client_use_instance_store           = var.client_use_instance_store
