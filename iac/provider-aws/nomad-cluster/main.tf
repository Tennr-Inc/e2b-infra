...
module "client" {
  ...
  max_cluster_size    = var.client_max_cluster_size
  machine_type        = var.client_machine_type
  use_instance_store  = var.client_use_instance_store
  ebs_kms_key_arn     = var.ebs_kms_key_arn
  ...
  sandbox_memory_limit_mib          = var.client_sandbox_memory_limit_mib
  max_sandboxes_per_node            = var.client_max_sandboxes_per_node
  reserved_host_memory_mib          = var.client_reserved_host_memory_mib
