...
For manual removal, first prevent placement and drain running sandboxes, then remove protection
and lower desired capacity. Stopping an orchestrator or reducing capacity without this process
can discard active work.
